...
export const ja: Translations = {
  ...
  serverError: {
    ...
    UPSTREAM_TIMEOUT: 'アップストリームがタイムアウトしました。もう一度お試しください。',
    UPSTREAM_TOO_LARGE: 'メディアファイルが大きすぎてプロキシできません。小さい動画を試すか、ソース URL を直接開いてください。',
    RATE_LIMITED: 'リクエストが多すぎます。1 分ほど待ってから再度お試しください。',
